...
| `song_plus_phev` | APROVADO | alto | sim | SONG PLUS PREM DM |
...
| `defender_d300` | APROVADO | alto | sim | DEFENDER 110 HSE |
| `discovery_sport_p250` | APROVADO | alto | sim | DISCOVERY SPORT P250FF SERD7 |
| `towner_pickup` | APROVADO | alto | sim | START PICKUP L |
| `huracan_sterrato` | APROVADO | alto | sim | HURACAN TECNICA |
| `aventador_ano_distante` | APROVADO | medio | não | AVENTADOR |
...
| `toyota_yaris_xls_zero_km` | APROVADO | alto | sim | YARIS HATCHBACK XLS (MY 2024) |
| `toyota_corolla_cross_hybrid` | APROVADO | alto | sim | COROLLA CROSS XRX HYBRID |
| `byd_dolphin_mini` | APROVADO | alto | sim | DOLPHIN MINI GL5EV |
